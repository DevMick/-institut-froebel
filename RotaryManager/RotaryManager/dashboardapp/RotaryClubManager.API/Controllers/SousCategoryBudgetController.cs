    ...
    public class SousCategoryBudgetController : ControllerBase
    {
            ...
            [FromQuery] string? recherche = null)
        {
            try
            {
                ...
                {
                    _logger.LogWarning("Tentative d'accès non autorisé aux sous-catégories du club {ClubId}", clubId);
                ...
                {
                    _logger.LogWarning("Catégorie de budget {CategoryBudgetId} non trouvée", categoryBudgetId);
                ...
                _logger.LogInformation("Recherche sous-catégories pour clubId={ClubId}, categoryBudgetId={CategoryBudgetId} : {Count} trouvées", clubId, categoryBudgetId, sousCategories.Count);
